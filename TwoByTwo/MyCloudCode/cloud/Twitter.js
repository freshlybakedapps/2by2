...
exports.init = function(app){
     ...
     */
    var githubClientId = 'PsAu0NtBDTAypN1Rt24GZODLN';
    var githubClientSecret = 'VyWrqwPEeNBS9DuqUC7Mhvtymdx3cYcDgvZ7b10ek3K8yVXwDk';

    var githubRedirectEndpoint = 'https://api.twitter.com/oauth/request_token?';
    var githubValidateEndpoint = 'https://api.twitter.com/oauth/access_token';
    var githubUserEndpoint = 'https://api.twitter.com/1.1/users/show.json?screen_name=';
    ...
    app.get('/twitter', function(req, res) {
      res.render('views-twitter/login', {});
    });
      ...
      tokenRequest.save(null, { useMasterKey: true }).then(function(obj) {
        ...
        res.redirect(
          githubRedirectEndpoint + querystring.stringify({
            oauth_callback: "http://www.2by2app.com/oauthCallback"
          })
        );
      }, function(error) {
    ...
    app.get('/oauthCallback', function(req, res) {
      ...
      if (!(data && data.code && data.state)) {
        res.render('views-twitter/error', { errorMessage: 'Invalid auth response received.'});
        return;
      }
      ...
      Parse.Promise.as().then(function() {
         ...
         */
         ...
         res.render('views-twitter/store_auth', { sessionToken: user.getSessionToken() });
        ...
        res.render('views-twitter/error', { errorMessage: JSON.stringify(error) });
      });
    ...
    var newGitHubUser = function(accessToken, githubData) {
      ...
      return user.signUp().then(function(user) {
        ...
        ts.set('twitterId', githubData.id);
