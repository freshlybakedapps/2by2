 ...
 */
var githubClientId = '164442adcb9fd4c3fac7';
var githubClientSecret = '7a0842bf5319e3dfc0e59bc28c6452189574ccb4';
...
app.get('/oauthCallback', function(req, res) {
  ...
  if (!(data && data.code && data.state)) {
    res.render('views-github/error', { errorMessage: 'Invalid auth response received.'});
    return;
  }
  ...
  Parse.Promise.as().then(function() {
     ...
     */
     ...
     res.render('views-github/store_auth', { sessionToken: user.getSessionToken() });
    ...
    res.render('views-github/error', { errorMessage: JSON.stringify(error) });
  });
