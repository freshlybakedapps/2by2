...
extern NSString * const PFLocationFullStrKey;
extern NSString * const PFLocationHalfStrKey;
...
@property (nonatomic, strong) NSString *locationFullStr;
@property (nonatomic, strong) NSString *locationHalfStr;
