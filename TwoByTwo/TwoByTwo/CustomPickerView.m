...
- (void)initialize
{
    ...
    CGFloat inset = (self.bounds.size.width - kItemSize) / 2;
    self.frontCollectionView.contentInset = self.rearCollectionView.contentInset = UIEdgeInsetsMake(0, inset, 0, inset);
